...
UNITREE_GO1_CFG = ArticulationCfg(
    ...
    # },
    actuators={
        "front_hip": DelayedPDActuatorCfg(
        ...
        "rear_hip": DelayedPDActuatorCfg(
            joint_names_expr=["RL_hip_joint","RR_hip_joint"],
            effort_limit=23.5,
            # saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=30.0,
        ...
        "front_thigh": DelayedPDActuatorCfg(
        ...
        "rear_thigh": DelayedPDActuatorCfg(
            joint_names_expr=["RL_thigh_joint","RR_thigh_joint"],
            effort_limit=23.5,
            # saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=30.0,
        ...
        "front_calf": DelayedPDActuatorCfg(
        ...
        "rear_calf": DelayedPDActuatorCfg(
            joint_names_expr=["RL_calf_joint","RR_calf_joint"],
            effort_limit=35.2,
            # saturation_effort=23.5,
            velocity_limit=20.0,
            stiffness=30.0,
