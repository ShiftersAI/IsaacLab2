...
from isaaclab.markers.config import RAY_CASTER_MARKER_CFG, RAY_CASTER_MARKER_G_CFG
...
@configclass
class RayCaster_G_Cfg(SensorBaseCfg):
    """Configuration for the ray-cast sensor."""
    ...
    visualizer_cfg: VisualizationMarkersCfg = RAY_CASTER_MARKER_G_CFG.replace(prim_path="/Visuals/RayCaster")
    """The configuration object for the visualization markers. Defaults to RAY_CASTER_MARKER_CFG.
